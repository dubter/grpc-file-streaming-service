...
const (
	FileTransferService_GetFile_FullMethodName     = "/file_transfer_grpc.FileTransferService/GetFile"
	FileTransferService_GetFileList_FullMethodName = "/file_transfer_grpc.FileTransferService/GetFileList"
	FileTransferService_GetFileInfo_FullMethodName = "/file_transfer_grpc.FileTransferService/GetFileInfo"
)
...
type FileTransferServiceClient interface {
	GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (FileTransferService_GetFileClient, error)
...
func (c *fileTransferServiceClient) GetFile(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (FileTransferService_GetFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileTransferService_ServiceDesc.Streams[0], FileTransferService_GetFile_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *fileTransferServiceClient) GetFileList(ctx context.Context, in *GetFileListRequest, opts ...grpc.CallOption) (*GetFileListResponse, error) {
	out := new(GetFileListResponse)
	err := c.cc.Invoke(ctx, FileTransferService_GetFileList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileTransferServiceClient) GetFileInfo(ctx context.Context, in *GetFileInfoRequest, opts ...grpc.CallOption) (*GetFileInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, FileTransferService_GetFileInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FileTransferServiceServer interface {
	GetFile(*GetFileRequest, FileTransferService_GetFileServer) error
...
func (UnimplementedFileTransferServiceServer) GetFile(*GetFileRequest, FileTransferService_GetFileServer) error {
	return status.Errorf(codes.Unimplemented, "method GetFile not implemented")
}
func (UnimplementedFileTransferServiceServer) GetFileList(context.Context, *GetFileListRequest) (*GetFileListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFileList not implemented")
}
func (UnimplementedFileTransferServiceServer) GetFileInfo(context.Context, *GetFileInfoRequest) (*GetFileInfoResponse, error) {
...
func _FileTransferService_GetFileList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FileTransferService_GetFileList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FileTransferServiceServer).GetFileList(ctx, req.(*GetFileListRequest))
	}
...
var FileTransferService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "file_transfer_grpc.FileTransferService",
